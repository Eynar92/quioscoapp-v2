        ...
        <div className="shadow p-5 mb-3 flex gap-10 items-center">
            ...
            <div>
                <button
                    ...
                    type="button"
                    className="bg-sky-700 flex items-center gap-2 px-5 py-2 text-white rounded-md font-bold uppercase shadow-md w-full text-center"
                >
                ...
                <button
                    ...
                    type="button"
                    className="bg-red-700 flex items-center gap-2 px-5 py-2 text-white rounded-md font-bold uppercase shadow-md w-full text-center mt-3"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
